<template>
  <div class="text-white bg-[#FFFFFF0A] p-4 pr-[54px] flex-col items-start gap-3 max-w-[1120px] rounded-[20px] border-[1px] border-[#FFFFFF14]">
...
import { dateConversion } from '#imports';
